...
class _LessonResultScreenState extends State<LessonResultScreen>
  ...
  Widget build(BuildContext context) {
    // Rebuild when app language changes so buttons stay in sync.
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      widget.unit.dark.withValues(alpha: 0.45),
                                  blurRadius: 32,
                        ...
                        Text(
                          perfect
                              ...
                              : '${widget.mistakes} ${EtStrings.mistakesLabel} · ${EtStrings.slowMotto}',
                          textAlign: TextAlign.center,
                          style: const TextStyle(
                        ...
                        const Center(
                          child: TibebBand(height: 14, opacity: 0.85),
                        ),
